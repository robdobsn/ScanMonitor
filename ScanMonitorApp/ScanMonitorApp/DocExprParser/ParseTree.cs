...
namespace TinyPgDocExpr
{
    ...
    public partial class ParseNode
    {
        ...
        internal object Eval(ParseTree tree, params object[] paramlist)
        {
            ...
            switch (Token.Type)
            {
                case TokenType.Start:
                    ...
                    break;
                case TokenType.LocatedString:
                    Value = EvalLocatedString(tree, paramlist);
                    break;
        ...
        protected virtual object EvalLocatedString(ParseTree tree, params object[] paramlist)
        {
            Console.WriteLine (this.GetValue(tree, TokenType.STRINGLITERAL, 0)); return false;
        }
        ...
        {
            return this.GetValue(tree, TokenType.LocatedString, 0);
        }
        ...
        {
            return this.GetValue(tree, TokenType.UnaryExpression, 0);
        }
